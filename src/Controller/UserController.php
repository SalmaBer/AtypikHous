...
class UserController extends AbstractController
{
     ...
     */
    public function reservations(ReservationRepository $reservationRepository, RoomRepository $roomRepository, UserRepository $userRepository,HotelRepository $hotelRepository): Response
    {
       ...
       // $reservations=$reservationRepository->findBy(['userid'=>$user->getId()]);
        $reservations=$reservationRepository->findBy(array('userid' => $user->getId()));
       // dump($reservations);
       // die();
     ...
     */
    public function reservationshow($id,ReservationRepository $reservationRepository, RoomRepository $roomRepository, UserRepository $userRepository,HotelRepository $hotelRepository): Response
    {
        $users=$userRepository->findAll();
        $hotels=$hotelRepository->findAll();
        $rooms=$roomRepository->findAll();
     ...
     */
    public function delete(Request $request, User $user, SettingRepository $settingRepository,HotelRepository $hotelRepository): Response
    {
